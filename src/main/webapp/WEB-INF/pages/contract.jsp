    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <ul class="nav nav-justified">
          ...
          <li class="active"><a href="<c:url value="/contract"/>"">Contratar</a></li>
      ...
      <div class="container">
        ...
        <p class="lead">Calcular o número de Pageview</p>
        <p class="lead">Informe o número de pageviews por mês de seu site:</p>
        <form:form modelAttribute="pageView">
        <p class="lead"><form:input path="pageViews" id="pageViewsInput"/></p>
        <button class="btn btn-lg btn-primary" type="submit">Calcular</button>
        </form:form>
        <p class="lead"></p>
        <p class="lead">Número de Arvores: ${treesCount} <img alt="" src="<c:url value="/resources/img/tree-small.png"/>"></p>
